...
with open('data_matrix_similarities/progess.txt') as out_progess:
    out_progess.write('0\n')
    out_progess.write('0\n')

with open('data_matrix_similarities/matrix_similarities.json', 'w') as out_data:
    json.dump(similarities_matrix, out_data)
with open('data_matrix_similarities/user_book_rating.json', 'w') as out_data:
    json.dump(user_book, out_data)
with open('data_matrix_similarities/book_user_rating.json', 'w') as out_data:
    json.dump(book_user, out_data)
with open('data_matrix_similarities/book_rate_user.json', 'w') as out_data:
    json.dump(book_rate, out_data)

with open('data_matrix_similarities/user_book_with_no_rating_0.json', 'w') as out_data:
